    ...
    <div className="mb-2 w-full rounded-md bg-white p-4">
      <div className="flex items-center justify-between border-b pb-4">
        <div>
          <div className="mb-2 flex items-center">
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-gray-100"></div>
              <div className="h-6 w-24 rounded-md bg-gray-100"></div>
            </div>
          </div>
      ...
      <div className="flex w-full items-center justify-between border-b py-5">
        <div className="flex w-1/2 flex-col">
          ...
          <div className="h-6 w-16 mt-2 rounded-md bg-gray-100"></div>
        </div>
        <div className="flex w-1/2 flex-col">
          <div className="h-4 w-20 rounded-md bg-gray-100"></div>
          <div className="h-6 w-16 mt-2 rounded-md bg-gray-100"></div>
      ...
      <div className="pt-4 text-sm">
        <div className="h-4 w-28 rounded-md bg-gray-100"></div>
      </div>
    </div>
  );
}
